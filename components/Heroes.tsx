      ...
      <div className="container absolute inset-0 isolate mx-auto mb-[96px] mt-[96px] px-6 md:mt-[120px] lg:max-w-[1440px]">
        <div className="mx-auto flex h-full w-full flex-col justify-center px-0 sm:px-6 lg:m-auto lg:w-[95vh]">
          <div className="relative pb-[58px] sm:pb-[89px] lg:pb-[69px]">
            <h2 className="character-name z-10 mb-2 text-center text-[40px] font-bold capitalize leading-[48px] text-white sm:hidden">
              Shiba yukata
            </h2>
            <p className="mb-[40px] text-center text-base capitalize leading-[32px] text-white sm:hidden">
            ...
            <div className="absolute -bottom-10 w-full px-8 text-center sm:-bottom-20 lg:-bottom-24">
              <img
          ...
          <div className="heroes-carousel-mask p-1">
