  ...
  return (
    <footer className="flex h-screen flex-col pt-[72px] lg:h-screen">
      <Image
        ...
        quality={80}
      />
      <div className="container m-auto flex h-full w-full items-center justify-center px-4 py-12">
        <div className="footer-content-mask w-full rounded-lg bg-black bg-opacity-50 pr-1">
          <div className="footer-custom-scrollbar max-h-[calc(100vh-168px)] overflow-auto p-6 md:p-16">
